...
public:
    ...
    virtual IRWItem<QPollarF> * brownianMotion(double diff) = 0;
    virtual IRWSet<QPollarF> * multipleBrownianMotion(double diff) = 0;
    virtual IRWItem<double> * brownianMotionDisplacement(double diff) = 0;
    virtual IRWSet<double>* multipleBrownianMotionDisplacement(double diff) = 0;
