 ...
 * Author: fordem
 *
 * Created on August 15, 2015, 5:35 PM
 */
...
inline int xyorder( Point* p1, Point* p2 )
{
...
inline int E_compare( const void* v1, const void* v2 ) // qsort compare two events
{
    Event**    pe1 = (Event**)v1;
    Event**    pe2 = (Event**)v2;
...
// EventQueue Routines
inline EventQueue::EventQueue( Polygon &P )
{
    ix = 0;
...
inline SLseg* SweepLine::add( Event* E )
{
...
inline void SweepLine::remove( SLseg* s )
{
...
inline bool SweepLine::intersect( SLseg* s1, SLseg* s2)
{
...
inline bool simple_Polygon( Polygon &Pn )
{
    EventQueue  Eq(Pn);
    SweepLine   SL(Pn);
