...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Overlay_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Overlay_t qt_meta_stringdata_Overlay = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Overlay"
QT_MOC_LITERAL(1, 8, 9), // "foundSeed"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 17), // "ExpressionClicked"
QT_MOC_LITERAL(4, 37, 3) // "Pos"

    },
    "Overlay\0foundSeed\0\0ExpressionClicked\0"
    "Pos"
};
...
void Overlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->foundSeed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->ExpressionClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Overlay::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Overlay::foundSeed)) {
                *result = 0;
            }
        }
    }
...
void *Overlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Overlay.stringdata))
...
// SIGNAL 0
void Overlay::foundSeed(bool _t1)
{
